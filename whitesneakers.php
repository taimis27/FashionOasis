...
<html lang="eng">
    <head>
        ...
        <title>White Sneakers Exclusive Edition - FASHION OASIS</title>
...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
            <img src="whsneakers/gallery1.webp" width="100%" id="product-img">
        
        <div class="small-img-row">
            <div class="small-img-col">
                <img src="whsneakers/gallery1.webp" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="whsneakers/gallery2.webp" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="whsneakers/gallery3.webp" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="whsneakers/gallery4.webp" width="100%" class="small-img">
            </div>
        </div>
        ...
        <div class="col-2">
            ...
            for both casual and athleisure wear.</p>
        </div>
    </div>
</div>
