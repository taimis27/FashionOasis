...
<html lang="eng">
    <head>
        ...
        <title>Bucchi Black Handbag - FASHION OASIS</title>
...
<!------------single product details--------------->
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="bucchibag/product9.jpg" width="100%" id="product-img">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="bucchibag/product9.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="bucchibag/gallery2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="bucchibag/gallery3.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="bucchibag/gallery4.jpg" width="100%" class="small-img">
                    </div>
                </div>
                ...
                <div class="col-2">
                    ...
                    <h3>Product Details <i class="fa fa-indent"></i></h3> <!----there should be an ident after----->
                    <br>
                    <p>The Bucchi Black Handbag is not just an accessory, it's a symbol of your discerning taste and 
                    unyielding confidence. Its versatility knows no bounds, effortlessly transitioning from day to night, 
                    from casual outings to formal affairs. With its spacious interior and thoughtfully designed compartments, 
                    it's your perfect companion for keeping your essentials organized and within easy reach.</p>
                </div>
            </div>
        </div>
