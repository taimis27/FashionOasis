...
<html lang="eng">
    <head>
        ...
        <title>School Blue Shoes - FASHION OASIS</title>
...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
            <img src="schoolshoes/product12.webp" width="100%" id="product-img">
        
        <div class="small-img-row">
            <div class="small-img-col">
                <img src="schoolshoes/product12.webp" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="schoolshoes/gallery2.jpg" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="schoolshoes/gallery3.jpg" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="schoolshoes/gallery4.jpg" width="100%" class="small-img">
            </div>
        </div>
        ...
        <div class="col-2">
            ...
            <br>
            <p>Inspired by the boundless energy and curiosity of young minds, the School Blue Shoes are a vibrant 
            shade of blue that captures the spirit of discovery. The sleek and modern design effortlessly complements 
            any school uniform, adding a touch of personality to every stride.</p>
        </div>
    </div>
</div>
