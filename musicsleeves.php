...
<html lang="eng">
    <head>
        ...
        <title>MPL Music Sheet Long Sleeves - FASHION OASIS</title>
...
<!------------single product details--------------->
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="musicsleeves/product6.webp" width="100%" id="product-img">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="musicsleeves/product6.webp" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="musicsleeves/gallery2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="musicsleeves/gallery3.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="musicsleeves/gallery4.jpg" width="100%" class="small-img">
                    </div>
                </div>
                ...
                <div class="col-2">
                    ...
                    <br>
                    <p>Wrap yourself in understated grace and polished allure with MPL Music Sheet Long Sleeves. The clean 
                    music lines and crisp color evoke an air of refinement, while their versatility allows them to seamlessly 
                    transition from casual to formal occasions. Embrace the epitome of timeless style with these wardrobe essentials.</p>
                </div>
            </div>
        </div>
