...
<html lang="eng">
    <head>
        ...
        <title>Chanel Modern White Shoulder Bag - FASHION OASIS</title>
...
<!------------single product details--------------->
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="chanel/product2.jpg" width="100%" id="product-img">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="chanel/product2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="chanel/chanel2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="chanel/chanel3.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="chanel/chanel4.jpg" width="100%" class="small-img">
                    </div>
                </div>
                ...
                <div class="col-2">
                    ...
                    <br>
                    <p>This Chanel Shoulder Bag features a pristine white exterior crafted from premium,
                    durable materials, ensuring both style and longevity. The sleek and streamlined silhouette
                    exudes sophistication, making it the perfect companion for both casual outings and formal occasions.</p>
                </div>
            </div>
        </div>
