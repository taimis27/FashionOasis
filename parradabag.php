...
<html lang="eng">
    <head>
        ...
        <title>Parrada Black Handbag - FASHION OASIS</title>
    ...
    <body>
        ...
        <div class="navbar">
            ...
            <a href="cart.html"><i class="fas fa-shopping-cart fa-flip-horizontal fa-lg"></i></a>
...
<!------------single product details--------------->
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="parradabag/product10.jpg" width="100%" id="product-img">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="parradabag/product10.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="parradabag/gallery2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="parradabag/gallery3.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="parradabag/gallery4.jpg" width="100%" class="small-img">
                    </div>
                </div>
                ...
                <div class="col-2">
                    ...
                    craftsmanship and impeccable taste. The deep black hue exudes power and elegance, making a bold statement 
                    wherever you go. Its sleek silhouette and impeccable design showcase a harmonious blend of contemporary style and classic charm.</p>
                </div>
            </div>
        </div>
