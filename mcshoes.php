...
<html lang="eng">
    <head>
        ...
        <title>Michael Curry Casual Shoes - FASHION OASIS</title>
...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
            <img src="mcshoes/product11.jpg" width="100%" id="product-img">
        
        <div class="small-img-row">
            <div class="small-img-col">
                <img src="mcshoes/product11.jpg" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="mcshoes/gallery2.jpg" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="mcshoes/gallery3.jpg" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="mcshoes/gallery4.jpg" width="100%" class="small-img">
            </div>
        </div>
        ...
        <div class="col-2">
            ...
            <h3>Product Details <i class="fa fa-indent"></i></h3> <!----there should be an indent after----->
            <br>
            <p>Step into the realm of timeless elegance with Michael Curry Casual Shoes. This pristine hue embodies 
            purity and sophistication, while their versatile charm effortlessly elevates any ensemble. From casual 
            outings to formal affairs, these pristine companions are a fashion staple that never fails to make a striking statement.</p>
        </div>
    </div>
</div>
