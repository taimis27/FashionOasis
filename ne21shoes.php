...
<html lang="eng">
    <head>
        ...
        <title>NE21 Black Casual Shoes Limited Edition - FASHION OASIS</title>
...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
            <img src="ne21shoes/product3.jpg" width="100%" id="product-img">
        
        <div class="small-img-row">
            <div class="small-img-col">
                <img src="ne21shoes/product3.jpg" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="ne21shoes/gallery2.jpg" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="ne21shoes/gallery3.jpg" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="ne21shoes/gallery4.jpg" width="100%" class="small-img">
            </div>
        </div>
        ...
        <div class="col-2">
            ...
            <br>
            <p>Unleash your inner champion with the NE21 Black Casual Shoes Limited Edition, where power and
            style collide to unleash your athletic prowess. These captivating black sports shoes are crafted 
            to propel you to new heights, whether you're hitting the track, dominating the court, or conquering the gym.</p>
        </div>
    </div>
</div>
