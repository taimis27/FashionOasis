...
<html lang="eng">
    <head>
        ...
        <title>Good Wednesday Dress - FASHION OASIS</title>
...
<!------------single product details--------------->
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="gooddress/product8.webp" width="100%" id="product-img">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="gooddress/product8.webp" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="gooddress/gallery2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="gooddress/gallery3.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="gooddress/gallery4.jpg" width="100%" class="small-img">
                    </div>
                </div>
