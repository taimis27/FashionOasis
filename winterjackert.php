...
<html lang="eng">
    <head>
        ...
        <title>M4A1 Winter Cold Jacket - FASHION OASIS</title>
...
<!------------single product details--------------->
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="winterjacket/product7.webp" width="100%" id="product-img">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="winterjacket/product7.webp" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="winterjacket/gallery2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="winterjacket/gallery3.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="winterjacket/gallery4.jpg" width="100%" class="small-img">
                    </div>
                </div>
                ...
                <div class="col-2">
                    ...
                    <br>
                    <p>The M4A1 Winter Cold Jacket effortlessly transitions from day to night, adapting to your every 
                    mood and style. Its understated elegance serves as a perfect canvas for accessories, allowing you 
                    to showcase your personal flair. Adorn your wrists with delicate bracelets, or let a statement necklace 
                    graze against the collarbone, this garment is a blank canvas for your unique expression.</p>
                </div>
            </div>
        </div>
