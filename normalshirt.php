...
<html lang="eng">
    <head>
        ...
        <title>Normal Blue Shirt - FASHION OASIS</title>
...
<!------------single product details--------------->
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="normalshirt/product5.webp" width="100%" id="product-img">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="normalshirt/product5.webp" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="normalshirt/gallery2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="normalshirt/gallery3.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="normalshirt/gallery4.jpg" width="100%" class="small-img">
                    </div>
                </div>
                ...
                <div class="col-2">
                    ...
                    <br>
                    <p>Timeless style meets contemporary charm. Crafted with meticulous care, the Normal Blue Shirt 
                    features a captivating shade of blue that evokes a sense of tranquility and serenity. The soft and 
                    breathable fabric caresses your skin, providing unparalleled comfort throughout the day.</p>
                </div>
            </div>
        </div>
